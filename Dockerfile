...
RUN apt-get install -y git && \
  curl -Lo /usr/local/bin/sops https://github.com/mozilla/sops/releases/download/v3.7.1/sops-v3.7.1.linux && chmod +x /usr/local/bin/sops && \
...
RUN apt-get install update -y && apt-get curl -y
